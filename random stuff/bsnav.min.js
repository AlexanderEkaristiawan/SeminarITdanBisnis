!function(n) {
    ...
    var a = {
        ...
        mobileMenu: function() {
            n(".bsnav .navbar-mobile")[0] && n(".bsnav-mobile")[0] && (n(".bsnav .navbar-mobile").closest(".bsnav-dark")[0] && n(".bsnav-mobile .navbar").addClass("bsnav-dark"),
        ...
        sideMenu: function() {
            n(".bsnav-sidebar")[0] && (this.sideMenuNavigation(n(".bsnav-sidebar")),
        ...
        sideMenuNavigation: function(a) {
            a.find(".nav-link").on("click", function(s) {
                var i = n(this);
                i.siblings(".navbar-nav")[0] && (s.preventDefault(),
                i.parent().hasClass("in") ? (i.parent().removeClass("in"),
                i.parent().find(".in").removeClass("in"),
                i.parent().find(".navbar-nav").stop(!0).slideUp(300)) : (i.closest(".in")[0] || (a.find(".nav-item.in .navbar-nav").stop(!0).slideUp(300),
                    ...
                    !function() {
                        if (!a.hasClass("spying")) {
                            ...
                            i.map(function(i, o) {
                                ...
                                n("[data-scrollspy=" + i + "]").parent().addClass("active"))
                            })
                        }
                    }()
                }),
